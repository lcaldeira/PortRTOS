...
**     Version   : Component 01.012, Driver 01.07, CPU db: 3.00.069
**     Datasheet : MCF51QE128RM, Rev. 3, 9/2007
**     Date/Time : 13/8/2021, 19:30
**     Abstract  :
...
void __initialize_hardware(void)
{
  ...
  ICSSC = (unsigned char)((ICSSC & (unsigned char)~0x80) | (unsigned char)0x60); /* Initialization of the ICS status and control */
